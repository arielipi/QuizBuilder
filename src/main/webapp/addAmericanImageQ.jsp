...
<%="'" + LanguagesSupporter.addQuestionFillTime(language)
	...
	function addQuestion() {
		...
		newdiv.innerHTML = "<div class='form-group'>"
				+ "<div class='col-md-offset-3 col-md-9' id='incorrectDIVi" + counter + "'>"
				+ "<input class='form-control' type='file' id='incorrecti" + counter + "' name='incorrecti" + counter + "'>"
				+ "</div>" + "</div>"
	...
	function removeQuestion() {
		if (counter > 1) {
			var name = "incorrectDIVi" + counter;
			...
			<div class="col-md-6">
				...
				<form class="form-horizontal" action="AddQuestion"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<div id="ifYesImage" style="display: none" align="center">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input class="form-control" id="correct_answer" type="file"
					...
					<div id="incorrects">
						<div class="form-group">
							...
							<div class="col-md-9" id="incorrectDIVi1">
								<input class="form-control" id="incorrecti1" type="file"
									name="incorrecti1" data-step="4"
